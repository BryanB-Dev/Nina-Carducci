! function(a) {
  a.fn.mauGallery = function(t) {
      ...
      prevImage() {
          ...
          }), s = l[i] || l[l.length - 1], a(".lightboxImage").attr("src", a(s).attr("src"))
      },
      nextImage() {
          let t = null;
          a("img.gallery-item").each(function() {
          ...
          a(l).each(function(e) {
              a(t).attr("src") === a(this).attr("src") && (i = e + 1)
          }), s = l[i] || l[0], a(".lightboxImage").attr("src", a(s).attr("src"))
      },
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <img class="lightboxImage img-fluid" alt="Image de la modale"/>
      ...
      showItemTags(t, e, l) {
          var i = '<li class="nav-item"><a class="nav-link active active-tag" href="#" data-images-toggle="all">all</a></li>';
